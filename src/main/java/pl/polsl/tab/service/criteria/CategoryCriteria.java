package pl.polsl.tab.service.criteria;
...
/**
 * Criteria class for the {@link pl.polsl.tab.domain.Category} entity. This class is used
 * in {@link pl.polsl.tab.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, imageId, distinct);
    }
