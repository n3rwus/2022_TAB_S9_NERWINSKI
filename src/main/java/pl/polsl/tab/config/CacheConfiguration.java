...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pl.polsl.tab.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pl.polsl.tab.repository.UserRepository.USERS_BY_EMAIL_CACHE);
