...
import static pl.polsl.tab.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import pl.polsl.tab.config.Constants;
import pl.polsl.tab.domain.User;
import pl.polsl.tab.repository.AuthorityRepository;
import pl.polsl.tab.repository.UserRepository;
import pl.polsl.tab.security.AuthoritiesConstants;
import pl.polsl.tab.service.UserService;
import pl.polsl.tab.service.dto.AdminUserDTO;
import pl.polsl.tab.service.dto.PasswordChangeDTO;
import pl.polsl.tab.service.dto.UserDTO;
import pl.polsl.tab.web.rest.vm.KeyAndPasswordVM;
import pl.polsl.tab.web.rest.vm.ManagedUserVM;
